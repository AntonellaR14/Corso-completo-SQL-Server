...
JOIN Iscrizioni AS i
	ON s.StudenteId = i.StudenteId
	WHERE s.DataNascita IS NULL; -- STUDENTI SENZA DATA DI NASCITA
...
JOIN Iscrizioni AS i
	...
	-- Restituire la lista degli studenti iscritti almeno ad un corso, campi da visualizzare:Nome completo dello studente, codice fiscale, data di nascita, Nome del Corsoe descrizione del corso
